...
private final class LoopbackHTTPServer: @unchecked Sendable {
    ...
    private func respond(to requestData: Data, on connection: NWConnection) async {
        ...
        if method == "GET" {
            send(status: 200, object: readResponse(route), on: connection)
    ...
    private func readResponse(_ route: String) -> [String: Any] {
        ...
        case "/runtime_snapshot":
            result = ["runtime_visibility": ["operational_state": "stopped", "health": "not_ready", "connection_state": "disconnected", "automation_mode": "paper_only", "paper_execution_available": false, "counts": ["cycles": 0, "proposals": 0, "executions": 0, "reconciliation": 0, "audit_events": 0]], "safety": safety]
        case "/ai_status":
        ...
        case "/paper_execution_status":
            result = ["environment": "paper", "live_execution": false, "broker": "none", "broker_submission": false, "activated": false, "paused": false, "kill_switch": true, "degraded_conditions": [], "unmanaged_position_symbols": [], "open_positions": 0, "open_orders": 0, "deployed_paper_capital": "0", "remaining_governed_allocation": "0", "last_reconciliation": NSNull(), "last_order_intent": NSNull(), "last_submitted_order": NSNull(), "last_fill": NSNull(), "last_rejection": NSNull(), "safety": safety]
