...
import { ARTIFACTS_ROUTE, contributedRoutes, MESSAGING_ROUTE, ROUTES_AREA, SIGIL_ROUTE, SKILLS_ROUTE } from '../routes'
...
const SigilOperatorView = lazy(async () => ({ default: (await import('../sigil')).SigilOperatorView }))
...
const BUILTIN_PAGES: Record<string, { render: () => ReactNode; title: string }> = {
  ...
  [SIGIL_ROUTE]: { render: () => <SigilOperatorView />, title: 'Sigil Operator' },
